...
/**
 * @SWG\Definition(@SWG\Xml(name="BufferOperation"))
 */
class BufferOperation
{
    /**
     * @SWG\Property(description="The geometry WKT")
     * @var string
     */
    public $Geometry;

    /**
     * @SWG\Property(description="The coordinate system code of the input geometry")
     * @var string
     */
    public $CoordSys;

    /**
     * @SWG\Property(description="The distance to buffer")
     * @var number
     */
    public $Distance;

    /**
     * @SWG\Property(description="The desired output format of the buffered geometry. wkt or geojson")
     * @var string
     */
    public $Format;

    /**
     * @SWG\Property(description="The distance units. If not specified it will be assumed to be meters")
     * @var string
     */
    public $Units;

    /**
     * @SWG\Property(description="The coordinate system code to transform the buffered geometry to")
     * @var string
     */
    public $TransformTo;
}
