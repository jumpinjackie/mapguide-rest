...
class WktForEpsg4326Test extends ServiceTest {
    ...
    public function __testOperation($extension, $mimeType) {
        ...
        $resp = $this->apiTestAnon("/coordsys/epsg/4326/wkt.$extension", "GET", array());
        $this->assertStatusCodeIs(200, $resp);
        $this->assertMimeType($mimeType, $resp);
        $this->assertContentKind($resp, $extension);
        $this->assertValidWktResponse($resp, $extension, $wkt);

        $resp = $this->apiTestAdmin("/coordsys/epsg/4326/wkt.$extension", "GET", array());
        $this->assertStatusCodeIs(200, $resp);
        $this->assertMimeType($mimeType, $resp);
        $this->assertContentKind($resp, $extension);
        $this->assertValidWktResponse($resp, $extension, $wkt);
        ...
        //With session id
        $resp = $this->apiTest("/coordsys/epsg/4326/wkt.$extension", "GET", array("session" => $this->anonymousSessionId));
        $this->assertStatusCodeIs(200, $resp);
        $this->assertMimeType($mimeType, $resp);
        $this->assertContentKind($resp, $extension);
        $this->assertValidWktResponse($resp, $extension, $wkt);

        $resp = $this->apiTest("/coordsys/epsg/4326/wkt.$extension", "GET", array("session" => $this->adminSessionId));
        $this->assertStatusCodeIs(200, $resp);
        $this->assertMimeType($mimeType, $resp);
        $this->assertContentKind($resp, $extension);
        $this->assertValidWktResponse($resp, $extension, $wkt);
